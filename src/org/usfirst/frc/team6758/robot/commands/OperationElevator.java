...
public class OperationElevator extends Command {
    ...
    protected void execute() {
		...
		else if(OI.stick.getRawButton(6) && Robot.elevator.topLimit.get()) Robot.elevator.elevatorMotor.set(RobotMap.elevatorSpeed);
		else if(OI.stick.getRawButton(4) && Robot.elevator.bottomLimit.get()) Robot.elevator.elevatorMotor.set(-RobotMap.elevatorSpeed);
