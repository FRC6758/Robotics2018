...
public class OperationPneumatics extends Command {
    ...
    protected void execute() {
    	if(OI.stick.getRawButton(2)) Robot.pneumatics.kick();
		else Robot.pneumatics.retract();
		
		if(OI.stick.getTrigger() || OI.controller.getTriggerAxis(GenericHID.Hand.kLeft) > .9) Robot.pneumatics.releaseBox();
